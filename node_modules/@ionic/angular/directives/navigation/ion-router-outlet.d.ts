import { Location } from '@ionic/angular/directives/navigation/node_modules/@angular/common';
import { ComponentFactoryResolver, ComponentRef, ElementRef, EventEmitter, NgZone, OnDestroy, OnInit, ViewContainerRef } from '@ionic/angular/directives/navigation/node_modules/@angular/core';
import { ActivatedRoute, ChildrenOutletContexts, OutletContext, Router } from '@ionic/angular/directives/navigation/node_modules/@angular/router';
import { AnimationBuilder } from '@ionic/angular';
import { Config } from '@ionic/angular/providers/config';
