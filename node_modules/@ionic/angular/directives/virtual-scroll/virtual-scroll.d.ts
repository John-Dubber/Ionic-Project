import { ElementRef, IterableDiffers, NgZone, SimpleChanges, TrackByFunction } from '@ionic/angular/directives/virtual-scroll/node_modules/@angular/core';
import { FooterHeightFn, HeaderFn, HeaderHeightFn, ItemHeightFn } from '@ionic/angular/directives/virtual-scroll/node_modules/@ionic/core';
import { VirtualFooter } from '@ionic/angular/directives/virtual-scroll/virtual-footer';
import { VirtualHeader } from '@ionic/angular/directives/virtual-scroll/virtual-header';
import { VirtualItem } from '@ionic/angular/directives/virtual-scroll/virtual-item';
